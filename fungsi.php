...
function showTabelPerbandingan($jenis,$kriteria) {
	...
	?>
			<tr>
				<td>
					<div class="field">
						<div class="ui radio checkbox" style="display: flex;">
	...
	?>
						<input type="number" name="bobot<?php echo $urut?>" value="<?php echo $nilai?>" max="10">
					</div>
				</td>
			</tr>
			<?php
	...
	<br><br><input class="ui submit button btn btn-primary" type="submit" name="submit" value="SUBMIT" style="margin-left: 50%; position: absolute; margin-top: -30px;">
	</form>
